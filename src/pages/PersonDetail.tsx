...
const PersonDetail: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="h-screen flex items-center justify-center bg-obsidian">
        <div className="text-2xl font-display font-black text-brand animate-pulse uppercase tracking-tighter">
          Loading Actor...
        </div>
      </div>
    );
  ...
  return (
    <div className="pb-20 bg-transparent text-current min-h-screen">
      <SEO
        title={person.name}
        description={
          person.biography ||
          `Full biography and filmography of ${person.name}.`
        }
        image={
          person.profile_path
            ? tmdbService.getImageUrl(person.profile_path, "original")
            : undefined
        }
        type="profile"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="space-y-8 glass-card p-8 rounded-[2.5rem]">
              <h3 className="text-xs font-black uppercase text-brand tracking-[0.3em]">
                Personal Details
              </h3>
          ...
          >
            <div className="mb-12">
              <span className="text-brand font-black text-xs tracking-widest uppercase mb-4 block">
                Actor Spotlight
              </span>
